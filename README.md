...
**Pynal Destination** is an app that records and retraces stops from long drives and commutes with private, on-device location history. Built with [Flet](https://flet.dev/) and a local SQLite database.
